                ...
                <div className="flex-1 relative flex items-center group">
                  ...
                  <form onSubmit={handleSearchSubmit} className="w-full">
                    <input
                      ...
                      className="w-full h-16 md:h-20 pl-16 pr-8 bg-surface border-none text-xl md:text-3xl font-heading font-black text-foreground placeholder:text-text-secondary/10 focus:ring-0 transition-all uppercase tracking-tight"
                    />
                  </form>
                </div>
                <button
