    ...
    <>
      <header
        ...
        style={{
          ...
          '--header-height': scrolled ? '60px' : '90px'
        }}
      >
        <div className={`flex items-center justify-between transition-all duration-300 px-4 md:px-8 lg:px-12 ${scrolled ? 'h-[60px] md:h-[60px]' : 'h-[70px] md:h-[90px]'}`}>
          ...
          <div className="flex items-center gap-4 w-1/4">
            ...
            <Link href="/" className="group flex items-center relative z-20 transition-transform duration-300 hover:scale-105">
              <img
                ...
                alt="MUSCFIT Logo"
                className={`transition-all duration-300 w-auto object-contain ${scrolled ? 'h-[45px] md:h-[50px]' : 'h-[60px] md:h-[85px]'}`}
              />
            </Link>
          </div>
