...
export default function InfoPage({ params }) {
    const { slug } = params;
    const title = slug ? slug.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ') : 'Information';
        ...
        <div className="bg-white min-h-screen flex flex-col font-sans text-black">
            ...
            <main className="flex-grow pt-32 md:pt-40 px-4 md:px-8 max-w-[1000px] mx-auto w-full mb-20 animate-fade-in-up">
                ...
                <div className="prose prose-lg max-w-none text-zinc-700 space-y-6 leading-relaxed">
                    ...
                    <p>
                        At MUSCFIT, we are dedicated to providing you with the best experience possible.
                        Whether you are looking for information about our products, need assistance with your order,
                        or want to learn more about our brand values, you are in the right place.
                    </p>

                    <div className="bg-zinc-50 p-8 border border-zinc-100 my-8 rounded-sm">
                        <h3 className="text-2xl font-bold text-black mb-4 uppercase tracking-wide">Information Overview</h3>
                        <p className="mb-0">
                            This section is currently being updated with the latest details regarding <strong>{title}</strong>.
                            Our team is working hard to ensure you have the most accurate and helpful information.
                            In the meantime, if you have urgent inquiries, please contact our support team.
                        </p>
                    </div>

                    <p>
                        We appreciate your patience and support as we continue to build the ultimate fitness community.
                        Keep pushing your limits and stay tuned for updates.
                    </p>
