            ...
            <div className="flex gap-4 overflow-x-auto pb-4 lg:pb-0 lg:grid lg:grid-cols-3 lg:gap-4 no-scrollbar">
              ...
              <div className="flex-shrink-0 w-[120px] lg:w-auto">
                <div className="bg-black aspect-square flex items-center justify-center p-4 mb-2">
                  <span className="text-white font-heading font-black text-xl italic text-center leading-none">
                    MUSCFIT
                    <br />
                    <span className="text-xs font-normal not-italic tracking-widest text-zinc-400">
                      CENTRAL
                    </span>
                  </span>
                </div>
              ...
              <div className="flex-shrink-0 w-[120px] lg:w-auto">
                <div className="bg-black aspect-square flex items-center justify-center p-4 mb-2">
                  <div className="text-center">
                    <span className="text-white font-heading font-black text-xl italic block mb-1">
                      STUDENTS
                    </span>
                    <span className="text-white text-[10px] font-bold border border-white px-1">
                      10% OFF
                    </span>
                  </div>
                </div>
