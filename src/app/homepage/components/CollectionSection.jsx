      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 pb-4 border-b border-gray-100">
          <div>
            ...
            <h2 className="text-5xl md:text-8xl font-[family-name:var(--font-anton)] italic text-transparent bg-clip-text bg-gradient-to-br from-black via-gray-800 to-gray-400 tracking-wide drop-shadow-sm pr-12 pb-4 leading-tight">
              {title}
            </h2>
          </div>
