...
export default function Homepage() {
  const pageData = {
    promoBar: {
      message:
        '🔥 NEW YEAR SALE: Get 30% OFF on all compression wear | Free shipping on orders above ₹2,999',
      dismissible: false,
    },
    ...
    hero: {
      ...
      mobileHeroImage:
        'https://images.unsplash.com/photo-1548332441-ae3501183141?q=80&w=1000&auto=format&fit=crop',
      ...
      items: [
        {
          ...
          content:
            "MUSCFIT compression gear has completely transformed my training. The quality is unmatched, and I can feel the difference in my performance. These aren't just clothes – they're performance enhancers!",
          rating: 5,
          avatar:
            'https://img.rocket.new/generatedImages/rocket_gen_img_16829c3d1-1764649917360.png',
        ...
        },
        {
          ...
          content:
            'As someone who trains clients daily, I need gear that can keep up. MUSCFIT leggings offer perfect flexibility and support. The fabric quality is exceptional, and they look amazing too!',
          rating: 5,
          avatar:
            'https://img.rocket.new/generatedImages/rocket_gen_img_1ae819c95-1763294232847.png',
        ...
        },
        {
          ...
          content:
            "I've tried countless brands, but MUSCFIT stands out. Their running gear is lightweight, breathable, and durable. After 6 months of intense training, my gear still looks brand new!",
          rating: 5,
          avatar:
            'https://img.rocket.new/generatedImages/rocket_gen_img_177494afc-1765810586590.png',
    ...
    newsletter: {
      ...
      subtitle:
        'Get exclusive access to new drops, special offers, and fitness tips delivered to your inbox',
    },
