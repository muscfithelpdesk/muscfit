        ...
        <div className="mb-8">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-3 pl-12 bg-white border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary text-foreground"
            />
            <svg
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            <Link href="/women-catalog" className="group">
              <div className="bg-surface border border-border rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                ...
                <div className="p-6">
                  <h2 className="text-2xl font-bold text-foreground mb-2 group-hover:text-pink-600 transition-colors">
                    Women's Collection
                  </h2>
            ...
            <Link href="/compression-wear-catalog" className="group">
              <div className="bg-surface border border-border rounded-lg shadow-sm overflow-hidden hover:shadow-md transition-shadow">
                ...
                <div className="p-6">
                  <h2 className="text-2xl font-bold text-foreground mb-2 group-hover:text-orange-600 transition-colors">
                    Compression Wear
                  </h2>
                  <p className="text-text-secondary mb-4">
        ...
        {loading ? (
          ...
          <div className="space-y-12">
            ...
            {menProducts?.length > 0 && (
              <div>
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-2xl font-bold text-foreground">Men's Favorites</h2>
