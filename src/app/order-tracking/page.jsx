        ...
        <div className="bg-surface rounded-lg p-6 mb-8 border border-border">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-between">
              {['order_confirmed', 'processing', 'shipped', 'out_for_delivery', 'delivered']?.map(
                (status, index) => {
                    ...
                    <div key={status} className="flex flex-col items-center">
                      <div
                        className={`w-10 h-10 rounded-full flex items-center justify-center mb-2 transition-all ${
                          isCompleted ? 'bg-black text-white' : 'bg-muted text-text-secondary'
                      ...
                      <p
                        className={`text-xs text-center max-w-[80px] ${isCompleted ? 'text-black font-semibold' : 'text-text-secondary'}`}
                      >
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-lg font-semibold text-foreground">
                    {formatDate(latestTracking?.estimatedDelivery)}
                  </p>
                </div>
              ...
              {latestTracking?.trackingNumber && (
                <div className="mt-4 pt-4 border-t border-border">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      onClick={() =>
                        navigator?.clipboard?.writeText(latestTracking?.trackingNumber)
                      }
                ...
                {order?.tracking?.map((track, index) => (
                  <div key={track?.id} className="flex gap-4">
                    <div className="flex flex-col items-center">
                      <div
                        className={`w-3 h-3 rounded-full ${getStatusColor(track?.status)}`}
                      ></div>
