    ...
    <div className="min-h-screen bg-background pt-[80px]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
        ...
        <div className="relative mb-12 text-center lg:text-left overflow-hidden">
          <div className="absolute -top-24 -left-24 w-64 h-64 bg-pink-50 rounded-full blur-[100px] opacity-70 float-3d"></div>
          <div className="absolute -bottom-24 -right-24 w-64 h-64 bg-gray-50 rounded-full blur-[100px] opacity-50 float-3d animation-delay-2000"></div>
